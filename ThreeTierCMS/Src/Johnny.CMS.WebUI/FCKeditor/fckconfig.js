...
var sOtherPluginPath = FCKConfig.BasePath.substr(0, FCKConfig.BasePath.length - 7) + 'editor/plugins/' ;//FCKConfig自带插件包的位置
...
FCKConfig.Plugins.Add('fckEmbedMovies','en,it,fr',sOtherPluginPath);