...
function fontSize(type,objname){
  if (type=="b"){
    if(curfontsize<64){
      document.getElementById(objname).style.fontSize='25px';
      document.getElementById(objname).style.lineHeight='27px';
    }
  }
  else if(type=="m") {
    if(curfontsize>8){
      document.getElementById(objname).style.fontSize='12px';
      document.getElementById(objname).style.lineHeight='14px';
    }
  }
  else if(type=="c"){
     document.getElementById(objname).style.fontSize='20px';
     document.getElementById(objname).style.lineHeight='22px';
  }
}
