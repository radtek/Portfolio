<%@ Page Language="C#" MasterPageFile="~/admin/admin.master" AutoEventWireup="true" CodeBehind="topmenubinding.aspx.cs" Inherits="Johnny.CMS.admin.topmenubinding" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphPage" runat="Server" EnableViewState="false">
    ...
    <table class="table_field" cellSpacing="1" cellPadding="2" align="center">
	    <tr class="tr_field">
    	    <td align="center"><asp:Label ID="lblTopMenuName" runat="server"></asp:Label></td>
    	    <td colspan="4"><asp:DropDownList ID="ddlTopMenus" runat="server" Width="200px" AutoPostBack="True" OnSelectedIndexChanged="ddlTopMenus_SelectedIndexChanged" ></asp:DropDownList></td>
        </tr>
