...
Calendar.prototype.bindData = function () {
  ...
  if (calendar.dateControl != null)
  {
	  ...
	  this.selecteddate = new Date(calendar.dateControl.value.toDate());
	  }
  } 
  ...
  tds[i].style.backgroundColor = calendar.colors["td_bg_out"];
    ...
    if (dateArray[i] != "&nbsp;"){
      ...
      if (this.selecteddate!=null
			&& this.selecteddate.getFullYear()==calendar.date.getFullYear() 
			&& this.selecteddate.getMonth()==calendar.date.getMonth() 
			&& this.selecteddate.getDate() == dateArray[i]) {
