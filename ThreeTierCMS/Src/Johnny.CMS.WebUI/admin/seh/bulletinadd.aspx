<%@ Page Language="C#" MasterPageFile="~/admin/admin.master" AutoEventWireup="true" CodeBehind="bulletinadd.aspx.cs" Inherits="Johnny.CMS.admin.seh.bulletinadd" %>
...
<asp:Content ID="cntPage" ContentPlaceHolderID="cphPage" runat="Server" EnableViewState="false">
    <table class="table_field" cellSpacing="1" cellPadding="2" align="center">
	    ...
	    <tr class="tr_field">
   	    ...
   	    <tr class="tr_field">
    	    <td class="td_field_label"><zr:Literal ID="litURL" runat="server"/></td>
    	    <td><zr:TextBox id="txtURL" CssClass="long_input" runat="server" MaxLength="200"></zr:TextBox></td>
