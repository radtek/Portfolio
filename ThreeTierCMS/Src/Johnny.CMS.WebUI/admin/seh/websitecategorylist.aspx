<%@ Page Language="C#" MasterPageFile="~/admin/admin.master" AutoEventWireup="true" CodeBehind="websitecategorylist.aspx.cs" Inherits="Johnny.CMS.admin.seh.websitecategorylist" %>
        ...
        <zr:ManageGridView ID="myManageGridView" runat="server" PagingStyle="PrevNext" PageSize="15" OnPageIndexChanging="myManageGridView_PageIndexChanging" AutoGenerateColumns="False" SkinID="ManageList" AllowPaging="True" OnRowDeleting="myManageGridView_RowDeleting" OnRowCancelingEdit="myManageGridView_RowCancelingEdit" OnRowEditing="myManageGridView_RowEditing" OnRowCommand="myManageGridView_RowCommand" EnableModelValidation="True" >
            <Columns>
                ...
                <asp:TemplateField>
                    <headerstyle width="50px" />
                    <itemtemplate>
                        <asp:Label runat="server" Text='<%# Bind("WebsiteCategoryId") %>' id="lblId"></asp:Label>
                ...
                <asp:TemplateField>
                    ...
                    <itemtemplate>
                        <asp:TextBox id="txtUptWebsiteCategoryName" runat="server" Text='<%# Bind("WebsiteCategoryName") %>' MaxLength="50" Width="200px"></asp:TextBox> 
                    </itemtemplate>
                </asp:TemplateField>
            </Columns>                
        </zr:ManageGridView>
