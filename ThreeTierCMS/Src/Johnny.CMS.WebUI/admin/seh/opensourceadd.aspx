<%@ Page Language="C#" MasterPageFile="~/admin/admin.master" AutoEventWireup="true" CodeBehind="opensourceadd.aspx.cs" Inherits="Johnny.CMS.admin.seh.opensourceadd" %>
...
<asp:Content ID="cntPage" ContentPlaceHolderID="cphPage" runat="Server" EnableViewState="false">
    <table class="table_field" cellSpacing="1" cellPadding="2" align="center">
	    ...
	    <tr class="tr_field">
    	    <td class="td_field_label"><zr:Literal ID="litOpenSourceName" runat="server" Mandatory="True" /></td>
    	    <td><zr:TextBox id="txtOpenSourceName" CssClass="normal_input" runat="server" MaxLength="50" Required="true"></zr:TextBox></td>
    	    <td><asp:Panel ID="txtOpenSourceNameTip" runat="server"></asp:Panel></td>
        </tr>
	    <tr class="tr_field">
