<%@ Page Language="C#" MasterPageFile="~/admin/admin.master" AutoEventWireup="true" CodeBehind="administratoradd.aspx.cs" Inherits="Johnny.CMS.admin.access.administratoradd" %>
...
<asp:Content ID="cntPage" ContentPlaceHolderID="cphPage" runat="Server" EnableViewState="false">
    <table class="table_field" cellSpacing="1" cellPadding="2" align="center">
	    ...
	    <tr class="tr_field">
    	    ...
    	    <td class="td_field_input"><zr:TextBox id="txtAdminName" CssClass="normal_input" runat="server" MaxLength="50" Required="True"></zr:TextBox></td>
    	    <td class="td_field_info"><asp:Panel ID="txtAdminNameTip" runat="server"></asp:Panel></td>
        </tr>
	    <tr class="tr_field">
        ...
        <tr class="tr_field">
    	    ...
    	    <td><cc1:DateTextBox ID="txtValidFrom" runat="server" IsDisplayTime="False" Language="Chinese" CssClass="normal_input" Required="true" ValidateDateCN="true"></cc1:DateTextBox></td>
    	    <td><asp:Panel ID="txtValidFromTip" runat="server"></asp:Panel></td>
        </tr>
        <tr class="tr_field">
    	    <td class="td_field_label"><zr:Literal ID="litValidTo" runat="server" Mandatory="True" /></td>
    	    <td><cc1:DateTextBox ID="txtValidTo" runat="server" IsDisplayTime="False" Language="Chinese" CssClass="normal_input" Required="true" ValidateDateCN="true"></cc1:DateTextBox></td>
    	    <td><asp:Panel ID="txtValidToTip" runat="server"></asp:Panel></td>
        </tr>
   		<tr class="tr_field">
    ...
    <table align="center" cellspacing="0" border="0" width="98%">
        ...
        <tr>
            <td>
                ...
                <zr:Button ID="btnResetPassword" runat="server" ButtonType="ResetPassword" OnClick="btnResetPassword_Click" />                
            </td>
        </tr>
    </table>
</asp:Content>
