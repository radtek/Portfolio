<%@ Page Language="C#" MasterPageFile="~/admin/admin.master" AutoEventWireup="true" CodeBehind="permissioncategoryadd.aspx.cs" Inherits="Johnny.CMS.admin.access.permissioncategoryadd" %>
...
<asp:Content ID="cntPage" ContentPlaceHolderID="cphPage" runat="Server" EnableViewState="false">
    <table class="table_field" cellSpacing="1" cellPadding="2" align="center">
	    ...
	    <tr class="tr_field">
    	    ...
    	    <td class="td_field_input"><zr:TextBox id="txtPermissionCategoryName" CssClass="normal_input" runat="server" MaxLength="50" Required="true"></zr:TextBox></td>
    	    <td class="td_field_info"><asp:Panel ID="txtPermissionCategoryNameTip" runat="server"></asp:Panel></td>
        </tr>
    </table>
