<%@ Page Language="C#" MasterPageFile="~/admin/admin.master" AutoEventWireup="true" CodeBehind="rolelist.aspx.cs" Inherits="Johnny.CMS.admin.access.rolelist" culture="auto" %>
        ...
        <zr:ManageGridView ID="myManageGridView" runat="server" PagingStyle="PrevNext" PageSize="15" OnPageIndexChanging="myManageGridView_PageIndexChanging" AutoGenerateColumns="False" SkinID="ManageList" AllowPaging="True" OnRowDeleting="myManageGridView_RowDeleting" OnRowCancelingEdit="myManageGridView_RowCancelingEdit" OnRowEditing="myManageGridView_RowEditing" OnRowCommand="myManageGridView_RowCommand" EnableModelValidation="True" >
            <Columns>
                ...
                <asp:TemplateField>
                    <headerstyle width="50px" />
                    <itemtemplate>
                        <asp:Label runat="server" Text='<%# Bind("RoleId") %>' id="lblId"></asp:Label>
                ...
                <asp:TemplateField>
                    ...
                    <itemtemplate>                    
                        <asp:TextBox id="txtUptRoleName" runat="server" Text='<%# Bind("RoleName") %>' MaxLength="50" Width="100px"></asp:TextBox> 
                    </itemtemplate>                    
                </asp:TemplateField>
                <asp:TemplateField>
                    <itemstyle cssclass="gridview_lefttd" />
                    <itemtemplate>                    
                        <asp:TextBox id="txtUptDescription" runat="server" Text='<%# Bind("Description") %>' MaxLength="200" Width="350px"></asp:TextBox> 
                    </itemtemplate>                    
                </asp:TemplateField>
            </Columns>                
        </zr:ManageGridView>
