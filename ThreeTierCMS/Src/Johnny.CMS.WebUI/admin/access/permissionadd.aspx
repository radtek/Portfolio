<%@ Page Language="C#" MasterPageFile="~/admin/admin.master" AutoEventWireup="true" CodeBehind="permissionadd.aspx.cs" Inherits="Johnny.CMS.admin.access.permissionadd" %>
...
<asp:Content ID="cntPage" ContentPlaceHolderID="cphPage" runat="Server" EnableViewState="false">
    <table class="table_field" cellSpacing="1" cellPadding="2" align="center">
	    ...
	    <tr class="tr_field">
    	    <td class="td_field_label"><zr:Literal ID="litPermissionCategory" runat="server" Mandatory="True" /></td>
   	    ...
   	    <tr class="tr_field">
    	    <td class="td_field_label"><zr:Literal ID="litPermissionName" runat="server" Mandatory="True" /></td>
    	    <td><zr:TextBox id="txtPermissionName" CssClass="normal_input" runat="server" MaxLength="50" Required="true"></zr:TextBox></td>
    	    <td><asp:Panel ID="txtPermissionNameTip" runat="server"></asp:Panel></td>
        </tr>
    </table>
