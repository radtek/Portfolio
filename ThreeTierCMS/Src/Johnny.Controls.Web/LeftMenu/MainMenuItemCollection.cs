...
namespace Johnny.Controls.Web.LeftMenu
{
    ...
    public class MainMenuItemCollection : ICollection
    {
        ...
        public virtual void AddRange(MainMenuItemCollection items)
        {
        ...
        public virtual MainMenuItem this[int index]
        {
            get
            {
                return (MainMenuItem)menuItems[index];
            }
        }        
