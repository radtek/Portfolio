...
namespace Johnny.Controls.Web.WebTab
{
    ...
    [ToolboxItem(false)]
    public class WebTabPage : WebControl
    {     
        #region Contructors
        /// <summary>
        /// Creates a new MenuItem instance.
        /// </summary>
        public WebTabPage() { }		// empty, default constructor        
        /// <summary>
        /// Creates a new MenuItem instance.
        /// </summary>
        public WebTabPage(string itemText, string itemToolTip, string itemImage)
        {
