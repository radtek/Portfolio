...
namespace Johnny.Controls.Web.WebTab
{
    ...
    public class WebTabPageCollection : ICollection
    {
        ...
        public virtual void AddRange(WebTabPageCollection items)
        {
        ...
        public virtual WebTabPage this[int index]
        {
            get
            {
                return (WebTabPage)tabPages[index];
            }
        }
