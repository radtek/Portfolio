...
namespace Johnny.CMS.OM.SeH
{
    ...
    public partial class Article
    {
        ...
        /// Full constructor
        /// </summary>
        public Article(long articleid, int channelid, string channelname, string title, string subtitle, string keyword, string subcontent, string content, string firstimage, string copyfrom, int hits, bool istop, bool iselite, bool ispic, bool ispagetype, bool isverified, DateTime createdtime, int createdbyid, string createdbyname, DateTime updatedtime, int updatedbyid, string updatedbyname, int sequence)
        {
            this._articleid = articleid;
            this._channelid = channelid;
