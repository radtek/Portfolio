...
namespace Johnny.CMS.OM.SeH
{
    ...
    public partial class Release
    {
        ...
        /// Full constructor
        /// </summary>
        public Release(int releaseid, int softwareid, string softwarename, string releasename, DateTime releasedate, string description, int hits, int downloads, bool isdisplay, DateTime createdtime, int createdbyid, string createdbyname, DateTime updatedtime, int updatedbyid, string updatedbyname, int sequence)
        {
            this._releaseid = releaseid;
            this._softwareid = softwareid;
