...
namespace Johnny.CMS.OM.SeH
{
    ...
    public partial class Blog
    {
        ...
        /// Full constructor
        /// </summary>
        public Blog(int blogid, string title, int blogcategoryid, string blogcategoryname, string tag, string content, int hits, bool isdisplay, DateTime createdtime, int createdbyid, string createdbyname, DateTime updatedtime, int updatedbyid, string updatedbyname, int sequence)
        {
            this._blogid = blogid;
            this._title = title;
            this._blogcategoryid = blogcategoryid;
