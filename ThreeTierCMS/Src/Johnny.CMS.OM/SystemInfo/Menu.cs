...
namespace Johnny.CMS.OM.SystemInfo
{
    ...
    public partial class Menu
    {
        ...
        /// Full constructor
        /// </summary>
        public Menu(int menuid, string menuname, int menucategoryid, string menucategoryname, string pagelink, string tooltip, string image, int permissionid, bool isdisplay, int sequence)
        {
            this._menuid = menuid;
            this._menuname = menuname;
            this._menucategoryid = menucategoryid;
