...
namespace Johnny.Library.Helper
{
    ...
    {        
        ...
        #region IsNaturalNumberRange(object)
        /// <summary>
        /// 判断是否为null
        /// </summary>
        /// <param name="oValue">指定的object值</param>
        /// <returns>返回bool型判断结果</returns>
        public static bool IsNaturalNumberRange(object oValue, int min, int max)
        {
            if (!IsNaturalNumber(oValue))
                return false;
            int value = DataConvert.GetInt32(oValue);
